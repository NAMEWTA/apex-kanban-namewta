...
export function updateDocAt(docs: DocNode[], path: DocPath, updater: (d: DocNode) => DocNode): DocNode[] {
...
export function removeDocAt(docs: DocNode[], path: DocPath): { docs: DocNode[]; removed: DocNode | undefined } {
...
export function insertDocAt(docs: DocNode[], parentPath: DocPath, index: number, node: DocNode): DocNode[] {
...
export function insertDocSibling(docs: DocNode[], path: DocPath, node: DocNode, before: boolean): DocNode[] {
 ...
 */
export function moveDocBeside(docs: DocNode[], srcPath: DocPath, destPath: DocPath, before: boolean): DocNode[] {
