...
export function renderWereadStats(
	content: HTMLElement,
	client: WereadClient,
	widget: { id: string; statsItems?: WereadStatItem[] },
...
function renderDaysHeatmap(
	...
	for (const cell of cells) {
		const cls = cell.inWindow
			? 'dashboard-weread-heatmap-cell dashboard-weread-heatmap-cell--l' +
				heatLevel(cell.seconds) +
