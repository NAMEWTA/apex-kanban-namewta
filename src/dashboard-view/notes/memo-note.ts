...
import { ensureFolder } from '../calendar/daily-notes';
import { mergeTemplateNoteContent } from '../library/library-new-note';
import { memoCardText } from '../persist/card-move';
import { nowMoment, type MomentLike } from '../../shared/datetime';
