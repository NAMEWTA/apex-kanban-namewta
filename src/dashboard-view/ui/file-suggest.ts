...
import { isSupportedExtension } from '../../shared/file-types';
...
export function attachFileSuggest(inputEl: HTMLTextAreaElement | HTMLInputElement, app: App): FileSuggestHandle {
