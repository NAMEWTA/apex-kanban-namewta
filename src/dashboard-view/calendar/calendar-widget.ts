...
function showDayPreview(anchor: HTMLElement, iso: string, tasks: VaultTask[], app: App): void {
	...
	const left = placeRight ? rect.right + margin : Math.max(margin, rect.left - margin - pw);
...
export function renderSidebarCalendar(
	...
	async function render(): Promise<void> {
		...
		// user's live todos. An exclusion covering the dashboard's folder
		// (e.g. 'assets') would otherwise hide those tasks.
