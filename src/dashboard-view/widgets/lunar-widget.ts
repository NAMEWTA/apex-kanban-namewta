...
import { fetchHolidayData, getHolidayForDate, type HolidayInfo } from '../calendar/holiday-service';
...
export function renderSidebarLunarWidget(
	...
	if (commaIndex !== -1) {
		almanacEl.createSpan({
			cls: 'dashboard-sidebar-lunar-almanac-text',
			text: data.almanac.slice(0, commaIndex + 1),
		});
