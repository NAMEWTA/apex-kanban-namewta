 ...
 * The modal:
 *
 *   1. Tells the user which command was probed and where NAND looked.
 ...
 * to paste it into a shell themselves. This keeps NAND on the right side
...
export interface LauncherInstallModalOptions {
   ...
   * spawn a NAND terminal and run the upgrade command in it. Only
   ...
   * spawn a NAND terminal and run the install command in it. Only
