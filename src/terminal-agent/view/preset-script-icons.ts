...
import geminiSvgMarkup from '../assets/google-gemini-icon.svg';
import type { SimpleIcon } from 'simple-icons';
import { isBlackWhiteSimpleIcon, resolveSimpleIconColor } from './simple-icon-colors';
import {
  siAnthropic,
  siCloudflare,
  siClaude,
...
function createGeminiSvg(): SVGSVGElement {
  geminiIconCounter += 1;
  const idPrefix = `nand-preset-gemini-${geminiIconCounter}`;
