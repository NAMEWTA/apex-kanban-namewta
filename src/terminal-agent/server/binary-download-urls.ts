import type { BinaryDownloadSource } from '../settings/model';

export const GITHUB_RELEASE_REPOSITORY = 'NAMEWTA/nand';
export const SERVER_BINARY_PREFIX = 'rust-terminal-servers';
