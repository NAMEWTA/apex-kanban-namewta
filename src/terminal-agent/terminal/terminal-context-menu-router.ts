 ...
 * "paste from clipboard". NAND historically intercepts every contextmenu
 ...
 * - `'menu'`     : show NAND's context menu (the historical default).
 * - `'suppress'` : do not show NAND's menu and do not paste either. The
 *                  expected caller is a TUI like Claude Code that already
 *                  handles right-click on its own through xterm.js's mouse
 *                  tracking mode; NAND just steps out of the way so the
 ...
 *   every other shell keeps NAND's menu.
 */
