...
import type { ShellType, TerminalSettings} from '../settings/model';
import {
...
import type { PendingTerminalSession } from '../launch/types';
...
let terminalInstanceModule: typeof import('./terminal-instance') | null = null;
const preloadTerminalInstance = async () => {
  if (!terminalInstanceModule) {
    terminalInstanceModule = await import('./terminal-instance');
  }
